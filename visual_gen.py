...
Freedom = df[['hf_score','GNI_capita']]
Happiness = df[['Happiness.Score', 'GNI_capita']]
...
#Plot 2: What is the relationship between different regions and their respective happiness and freedom?
...
plt.savefig("fig2_hap_freedom_region", dpi=500)
plt.show()
...
plt.tight_layout()
plt.savefig("fig3_hap_free_means_by_region", dpi=500)
plt.show()
